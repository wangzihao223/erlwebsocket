-module(raw_ws_connection_tests).

-include_lib("eunit/include/eunit.hrl").

-define(WS_GUID, <<"258EAFA5-E914-47DA-95CA-C5AB0DC85B11">>).

active_once_receives_fragmented_text_test() ->
    ...
    {ok, Pid} = raw_ws_connection:start_link("localhost", Port, "/ws", [{timeout, 1000}]),
    receive
        {websocket, Pid, {text, <<"hello">>}} ->
            ok
    after 1000 ->
        ?assert(false)
    end,
